...
public class Base64Encoder {
	...
	/**
	 * Converts a binary data into a Base64 encoded string. If the binary data is
	 * null or a zero-length array, an empty string is returned.
	 *
	 * @param value A byte array to encode. If it is null or a zero-length array, an
	...
	/**
	 * Converts a Base64 encoded string into a binary data. If the string is null or
	 * an empty string, a zero-length array is returned.
	 *
	 * @param value A Base64 encoded string to decode. The length of the string must
	 *              be a multiple of 4. If it is null or an empty string, a
	...
	public static byte[] decode(String value) throws Exception {
		...
		// Converts the Base64 encoded string into a binary data. (4 characters to 3
		// bytes)
		int outputIndex = 0, bufferIndex = 0;
