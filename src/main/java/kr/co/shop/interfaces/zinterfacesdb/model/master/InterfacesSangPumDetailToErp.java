...
@Data
public class InterfacesSangPumDetailToErp {
	...
	private java.sql.Timestamp wmsRegDate;
	
	private java.sql.Timestamp wmsConDate;

	private int arsqty;
	
	private java.sql.Timestamp arsStockRegDate;
	
	private java.sql.Timestamp arsStockConDate;
	
	private String arsCBCd;
