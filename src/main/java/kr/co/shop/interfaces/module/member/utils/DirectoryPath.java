...
public class DirectoryPath {
	...
	public void analysis() {
		...
		/*
		 * 2008-03-14 basePath 링크가 baseurl?directory=/abc/efg/ 이런형식일때 생기는 버그 basePath의
		 * 쿼리를 때어낸다. 후에 파일명에 다시 쿼리를 붙인다.
		 */
				...
				if (preChar != null && preChar == ':') {
					...
					if ("..".equals(newDir)) {
						if (this.dirList.isEmpty()) {
							/*
							 * throw new ScrapperException("First Directory is [..]"); 수정 2008-03-10 브라우져
							 * 동작과 같이간다. 첫디렉토리에 [..]인데 상위디랙토리가없으면 [..]를 무시한다.
							 */
						} else {
